          ...
          <Container>
            ...
            <Grid>
              ...
              <div>
                ...
                <p>
                  <strong>Players: </strong>3 people from each team, minimum 1
                  girl.
                </p>
              </div>
            </Grid>
            ...
            <ul>
              <li>
                Teams may clean the stacking area before they start. Teams may
                only use a shirt to stack cups on top of, if desired. The game
                starts after a countdown from ten (10).
              </li>
              <li>
                If a player spills it will be a minor, major, or double major to
                be determined by a committee member. If a player pukes into one
                of their cups it is a double major. Puking into a puke bag is
                allowed.
              </li>
