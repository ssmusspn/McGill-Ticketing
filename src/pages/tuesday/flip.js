          ...
          render={data => (
            <Section id="flipcup">
              <Container>
                ...
                <p>
                  Teams face each other each having two 1/3 beers in front of
                  them. They chug one and flip the cup. It is a race there and
                  back. The fastest team moves on, bracket style.
                </p>
                <h2>Bracket</h2>
