          ...
          render={data => (
            <Section id="teams">
              <Container>
                ...
                <br />
                <p>
                  Did someone say DUSTED? Wexit might not be the theme this year
                  but we might still end up in the Wild Wild West tonight... or
                  East... or South. Maybe we'll even end up at Mac Campus haha
                  jk... unless?
                </p>
                <br />
                <h2>Dusted Buses</h2>
                <ul>
                  <li>
                    ...
                    tolerance policy for anyone who breaks the rules on DUSTED
                    buses
                  </li>
                  <li>
                    ...
                    <ul>
                      <li>
                        ...
                        bus, its going to be a long ride, pace yourself. No
                        matter what, DO NOT THROW your bottle of "liquids" out
                        the window
                      </li>
                    </ul>
                  </li>
                ...
                <p>
                  Busses will be depart the venue to Jeanne-Mance Park starting
                  at
                  <strong>11PM.</strong>
                </p>
                <h2>Activities</h2>
                <ul>
                  ...
                  <li>
                    <StyledLink to="/tuesday/fliptactoe">
                      Flip Tac Toe
                    </StyledLink>
                  </li>
                </ul>
