      ...
      render={data => (
        <Section id="timetrials">
          <Container>
            ...
            <Grid>
              <Art>
                <Img fluid={data.art_timetrials_meme.childImageSharp.fluid} />
              </Art>
              <div>
            ...
            <br />
            <p>
              We came, we saw, we raced. Come on down to Time Trials to scout
              out your competition for the Grand Prix coming up later this week!
            </p>
