          ...
          render={data => (
            <Section id="mcat">
              <Container>
                ...
                <br />
                <p>
                  A test based on questions from different faculties. 2 people
                  per team, 1 pitcher and 3 shots per person. Science this may
                  be your only shot to actually do well on the MCAT (we know
                  you’re not going to med school anyways)
                </p>
                ...
                <h4>Wave 2: 1PM</h4>
                <p>
                  Arts 3, Arts 4, Arts 5, Engineering, Management 2, Education
                  2, Science 2, PTOT
                </p>
                <h2>Points</h2>
