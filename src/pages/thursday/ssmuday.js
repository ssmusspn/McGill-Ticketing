        ...
        <Section id="ssmuday">
          <Container>
            ...
            <ul>
              ...
              <li>
                <StyledLink to="/thursday/beeriokart">Beerio Kart</StyledLink>
              </li>
              <li>
                <StyledLink to="/thursday/debates">Drunk Debates</StyledLink>
              </li>
              <li>
                <StyledLink to="/thursday/casecrack">Case Crack</StyledLink>
              </li>
              <li>
                <StyledLink to="/thursday/pitcherpass">Pitcher Pass</StyledLink>
              </li>
              <li>
                <StyledLink to="/thursday/spellingbee">Spelling Bee</StyledLink>
              </li>
              <li>
              ...
              <li>
                <StyledLink to="/thursday/fearoffood">Fear of Food</StyledLink>
              </li>
            </ul>
            <h2>Schedule</h2>
