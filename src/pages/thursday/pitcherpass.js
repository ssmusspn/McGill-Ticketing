      ...
      render={data => (
        <Section id="pitcherpass">
          <Container>
            ...
            <Grid>
              <Art>
                <Img fluid={data.art_pitcherpass_meme.childImageSharp.fluid} />
              </Art>
              <div>
                ...
                <p>
                  <strong>Players: </strong>Three people per team, at least one
                  girl.
                </p>
              </div>
            </Grid>
            <br />
            <p>
              Three people from each team form a circle with other players. They
              must each drink beer out of the bucket continuously until they
              choose to stop and then pass it to the person beside them. Any
              person can continuously chug the pitcher as long as they please,
              but if they choose to stop must pass it to the person to their
              right. Fastest time wins.
            </p>
            <h2 id="rules">Rules</h2>
            <ul>
              <li>
                Each player drinks as much beer as they'd like, then passes the
                bucket to their neighbor
              </li>

              <li>
                At least one girl must play per team (else, 30 second penalty)
              </li>
