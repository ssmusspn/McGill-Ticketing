            ...
            <Section id="casecrack">
              <Container>
                ...
                <Grid>
                  <Art>
                    <Img
                      fluid={data.art_casecrack_meme.childImageSharp.fluid}
                    />
                  </Art>
                  <div>
                ...
                <br />
                <p>
                  Just because Faculty Olympics isn’t run by the MUS doesn’t
                  mean we can’t get sharky. The best way to prepare for that
                  case interview is to train in the mountains, or in this case:
                  train intoxicated. In this game of cunning, a team of up to 5
                  must finish 4 pitchers of beer while creating a fun and flirty
                  proposal on a poster board that you’ll present to committee.
                  Emphasis on the fun but mostly on the flirty ;). Best proposal
                  = most points!
                </p>
