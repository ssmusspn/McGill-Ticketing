            ...
            <Section id="dodgeball">
              <Container>
                ...
                <Grid>
                  <Art>
                    <Img
                      fluid={data.art_dodgeball_meme.childImageSharp.fluid}
                    />
                  </Art>
                  <div>
                ...
                <ul>
                  ...
                  <li>
                    You can block using another ball but must retain control of
                    it
                  </li>
                </ul>

                <p>
                  Games go up to 5 minutes, after which the team that has the
                  most people. Finals and 3rd place games will last 10 minutes.
                </p>
                <h2>Bracket</h2>
