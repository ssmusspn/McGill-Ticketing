          ...
          render={data => (
            <Section id="limbo">
              <Container>
                ...
                <br />
                <p>
                  Show off your fitness skills and your flexibility. When it
                  comes to limbo, you're either good at it or you aren't.
                </p>
                ...
                <ul>
                  ...
                  <li>
                    Each participant gets one shot of fireball, every two
                    rounds. Participants get two chances per turn to make it
                    under the limbo stick and remain standing on the other end.
                    If both participants make it through, they both attempt
                    again at a lower height. If neither participant can make it
                    through at the given level, it is settled by a chug off.
                  </li>
                </ul>
                <h2>Brackets</h2>
