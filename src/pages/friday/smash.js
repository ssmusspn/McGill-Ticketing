          ...
          <Container>
            ...
            <ul>
              ...
              <li>
                <p>
                  <em>
                    In the case of it going to time, the winner is whoever or
                    whichever team has more stocks. If the stocks are even, it
                    is whoever or whichever team has less accumulated percent.
                    If stocks and percent are equal, a 1 stock, 3-minute,
                    rematch is played.
                  </em>
                </p>
              </li>
              ...
              <li>
                <p>
                  <strong>TEAM ATTACK ON</strong> (stock sharing allowed, done
                  by pressing A+B)
                </p>
              </li>
              ...
              <li>
                <p>
                  ...
                  everyone writes their character down, or tells a 3 party, then
                  reveals all character choices together.
                </p>
              </li>
              <li>
                <p>
                  The starting stage is picked by commonly agreeing to
                  Smashville, or by doing rock-paper-scissors, where the winner
                  will strike 1 stage, the loser then strikes 2 stages, and the
                  winner strikes 1 more stage, which leaves 1 final starter
                  stage to play on.
                </p>
              </li>
              <li>
              ...
              <li>
                <p>
                  ...
                  stagelist of starters and counterpicks. The loser then gets to
                  select the stage they wish to play on for the following game.
                </p>
              </li>

              <li>
                <p>
                  DAVE’S STUPID RULE: You cannot select a stage you have already
                  won in that set.
                </p>
              </li>
            </ul>
